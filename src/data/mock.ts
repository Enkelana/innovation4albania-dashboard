...
const raw: Omit<Project, "lastUpdated">[] = [
  ...
  },
  {
    ...
    name: "Projekt 2",
    description: "Përshkrim i përgjithshëm i projektit.",
    ministries: ["—"],
    status: "active",
    ...
    risk: "low",
    team: ["—", "—", "—"],
    lead: "—", updateCadenceDays: 7, budgetMln: 28.0,
  },
  {
    ...
    risk: "high",
    team: ["—", "—", "—"],
    lead: "—", updateCadenceDays: 14, budgetMln: 145,
  },
  {
    ...
    risk: "low",
    team: ["—", "—"],
    lead: "—", updateCadenceDays: 7, budgetMln: 42,
  },
  {
    ...
    risk: "low",
    team: ["—", "—", "—"],
    lead: "—", updateCadenceDays: 14, budgetMln: 18.6,
  },
  {
    ...
    risk: "medium",
    team: ["—", "—", "—"],
    lead: "—", updateCadenceDays: 14, budgetMln: 64,
  },
  {
    ...
    risk: "medium",
    team: ["—", "—"],
    lead: "—", updateCadenceDays: 14, budgetMln: 9.4,
  },
  {
    ...
    risk: "critical",
    team: ["—", "—"],
    lead: "—", updateCadenceDays: 14, budgetMln: 980,
  },
  {
    ...
    risk: "low",
    team: ["—", "—"],
    lead: "—", updateCadenceDays: 14, budgetMln: 22,
  },
  {
    ...
    risk: "high",
    team: ["—", "—"],
    lead: "—", updateCadenceDays: 14, budgetMln: 35,
  },
  {
    ...
    risk: "low",
    team: ["—", "—"],
    lead: "—", updateCadenceDays: 7, budgetMln: 15.2,
  },
  {
    ...
    risk: "medium",
    team: ["—", "—"],
    lead: "—", updateCadenceDays: 7, budgetMln: 220,
  },
];
...
export const EVENTS: ProjectEvent[] = [
  ...
  { id: "e3", projectId: "p1", date: iso(14),  type: "deadline", title: "Dorëzim raporti mes-fazor" },
  { id: "e4", projectId: "p2", date: iso(1),   type: "delivery", title: "Lëshim versioni v3.0 RC" },
  { id: "e5", projectId: "p2", date: iso(8),   type: "meeting", title: "Testim me përdorues — qytetarë" },
  { id: "e6", projectId: "p3", date: iso(-4),  type: "deadline", title: "Dorëzim DRP" },
  { id: "e7", projectId: "p4", date: iso(20),  type: "delivery", title: "Mbyllje e shkollave të fundit" },
  ...
  { id: "e11", projectId: "p11", date: iso(5), type: "deadline", title: "Vënie në punë faturimi e-Tax" },
  ...
  { id: "e14", projectId: "p2", date: iso(-3), type: "delivery", title: "Portë API v2" },
];
